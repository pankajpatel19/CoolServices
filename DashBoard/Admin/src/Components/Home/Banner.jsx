...
function Banner() {
  return (
    <motion.div
      ...
      className="relative min-h-[300px] sm:min-h-[400px] md:min-h-[500px]  bg-cover bg-center bg-no-repeat bg-fixed flex items-center justify-center sticky top-0"
      style={{
    ...
    >
      ...
      <div className="relative text-center px-4 z-10">
        <h1 className="text-3xl sm:text-5xl md:text-6xl text-black font-bold font-serif mb-4 drop-shadow-lg">
          Fast Home Appliance Service
        </h1>
        <p className="text-black text-sm sm:text-lg mb-6 max-w-xl mx-auto font-light">
