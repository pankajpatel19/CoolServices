...
const Booking = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotification(
        error?.response?.data?.message || "Failed to book",
        "error"
      );
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 relative overflow-hidden">
      ...
      <AnimatePresence>
        {notification && (
          <motion.div
            ...
            className={`fixed top-8 right-8 z-50 px-7 py-5 rounded-2xl shadow-2xl backdrop-blur-xl ${
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/40 p-10 md:p-14 relative overflow-hidden"
        >
          {/* Decorative Elements */}
