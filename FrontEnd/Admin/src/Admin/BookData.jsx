      ...
      <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-slate-500 font-medium mb-8">
            The requested service file could not be discovered or has been
            archived.
          </p>
          <button
            onClick={() => navigate(-1)}
              ...
              <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-blue-100 font-bold text-sm">
                  <span className="flex items-center gap-2">
                    <Phone className="w-4 h-4 opacity-70" /> {booking.phone}
                  </span>
                  <span className="w-1 h-1 bg-white/30 rounded-full hidden md:block"></span>
                  <span className="flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 opacity-70" /> Primary
                    Customer
                  </span>
                </div>
              </div>
          ...
          <div className="p-10 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-slate-50/50 p-6 rounded-3xl border border-slate-100/50 group hover:border-indigo-100 transition-colors"
                >
                  <div
                    className={`p-3 bg-${spec.color}-100 rounded-2xl text-${spec.color}-600 w-fit mb-4 group-hover:scale-110 transition-transform`}
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-inner">
                <p className="text-slate-600 font-medium leading-relaxed">
                  {booking.issue ||
                    booking.description ||
                    "No specific technical diagnostics provided for this request."}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-slate-700">
                    {booking.technician || "Unassigned Operations"}
                  </p>
                </div>
              </div>
