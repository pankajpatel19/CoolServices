  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        {
          role: "system",
          content: "You are the AI assistant for Cool Service Store, a premium home appliance repair and maintenance service. You help customers with AC repair, plumbing, electrical issues, and general appliance maintenance. Be professional, direct, and empathetic. If asked about booking, guide them to the booking page."
        },
        {
          role: "user",
          content: data,
